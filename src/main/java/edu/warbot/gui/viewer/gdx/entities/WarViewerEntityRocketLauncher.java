...
public class WarViewerEntityRocketLauncher extends WarViewerEntityControllable
	...
	public WarViewerEntityRocketLauncher(int id, int patchX, int patchY,
		...
		texture = WarViewerGdx.getTexture("sheet_"
